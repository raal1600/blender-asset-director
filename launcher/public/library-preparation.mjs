...
export function preparationDialog({source,file,esc,b}) {
  return {body:`<p class="preparation-asset"><strong>${esc(source.name)}</strong></p>
    <p>Director will check a separate copy and prepare this asset for your library. No download or purchase. Your originals and scene stay unchanged.</p>
    <label class="preparation-confirm"><input id="prepare-confirm" type="checkbox"> <span>I confirm I have the right to use and adapt this asset in my productions and will follow its terms, including any required credits.</span></label>
    ...
    buttons:b('Confirm & prepare','source-prepare',{id:source.id,version:source.version,file},'primary',true)};
}
