    ...
    try {
      ...
      const action = async () => {
        ...
        if (req.method === 'GET') {
          ...
          if (p === '/api/workbench/catalog') return workbench.catalogPage(id,{query:url.searchParams.get('query')||'',offset:Number(url.searchParams.get('offset')||0),kind:url.searchParams.get('kind')||null,activity:url.searchParams.get('activity')||'all',subcategory:url.searchParams.get('subcategory')||null,excludeProduction:url.searchParams.get('excludeProduction')==='true'});
          if (p === '/api/workbench/catalog-detail') return workbench.catalogDetail(id,url.searchParams.get('assetId'));
          if (p === '/api/workbench/sources') return workbench.sourcePage(id,{query:url.searchParams.get('query')||'',kind:url.searchParams.get('kind')||'',activity:url.searchParams.get('activity')||'all',offset:Number(url.searchParams.get('offset')||0),sceneId:url.searchParams.get('sceneId'),selected:url.searchParams.get('selected')==='true',production:url.searchParams.get('production')==='true',excludeProduction:url.searchParams.get('excludeProduction')==='true',subcategory:url.searchParams.get('subcategory')||null});
          ...
          if (p === '/api/projects/audit') return runtime.audit(id,body.scene);
