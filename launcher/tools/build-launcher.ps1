...
& $compiler /nologo /target:winexe /platform:x64 /optimize+ /reference:System.Windows.Forms.dll /reference:System.Drawing.dll /reference:System.Web.Extensions.dll /reference:System.Management.dll ('/reference:'+(Join-Path $launcherRoot 'Microsoft.Web.WebView2.Core.dll')) ('/reference:'+(Join-Path $launcherRoot 'Microsoft.Web.WebView2.WinForms.dll')) ('/out:' + (Join-Path $launcherRoot 'Asset Director.exe')) (Join-Path $PSScriptRoot 'AssetDirectorLauncher.cs')
