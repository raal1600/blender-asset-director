    ...
    try:
        ...
        with Library(args.library) as lib:
            ...
            if command.startswith("motion-") or command == "retarget-profile":
                ...
                result={"schema":1,"render_frames":True,"gpu_render":True,"film_assemble":True,"task_workspace":True,"preview_camera":True,"catalog":True,"asset_preview":True,"asset_contents":True,"runtime":__version__,"implementation":jobs.implementation_hash(),"limits":{"frames_per_shot":360,"frames_per_film":3600,"render_seconds":900},"audio":False}
