...
Run factory background Blender -- OUTPUT_DIRECTORY.
"""
...
def main(directory):
    ...
    with Library(out/'library') as lib:
        ...
        _,proposal,_=run('transfer-plan',target_file,cid,{'target_object':target_name,
        ...
        report={'status':'PASS','blender':bpy.app.version_string,'same_reference':True,
